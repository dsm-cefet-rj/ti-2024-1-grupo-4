                ...
                <nav className="navbar navbar-expand-lg p-3">
                    ...
                    <div className="collapse navbar-collapse flex-row-reverse" id="navbarNavAltMarkup">
                        <div className="navbar-nav">
                            ...
                            <Link to = "/admin" className ="nav-link d-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="currentColor" classs="bi bi-bar-chart-fill" viewBox="0 0 16 16">
                            ...
                            <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1z"/>
                            </svg><span className='m-2'>Histórico</span></Link>
                            </>:
                            null}
                            ...
                            <Link to="/pedido" className="nav-link d-flex align-items-center">
