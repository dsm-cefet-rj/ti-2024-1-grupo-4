...
export class Setuppedido extends Component {
    continue = e =>{
        e.preventDefault();
        this.props.nextStep();
    };
  ...
  render() {
    ...
    <br/>
            <div className='row'>
                ...
                <div className='col-6'>
                    <div className='text-right'>
                        <Button className='btn custom-button bg-equator' onClick={this.continue}>Finalizar Pedido</Button>
                    </div>
                </div>
