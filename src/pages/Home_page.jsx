...
function Home_page() {
    ...
    return(
        <>
                ...
                <nav class="navbar fixed-top p-2 px-4 shadow-sm navbar-expand-lg navbar-light bg-light">
                    <div class="container d-flex-block align-items-center">
                            <img src={logo} width="50" height="50" alt=""></img>
                        <a class="navbar-brand ms-2" href="#">Nome</a>
            ...
            <header class="sticky-top p-2 px-4 shadow-sm bg-white">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="navbar-nav">
                        <a class="nav-item nav-link mx-1 d-flex align-items-center" href="#">
